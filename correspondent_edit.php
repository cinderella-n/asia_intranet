<?php
    ...
    $sql = "SELECT * FROM `correspondent_tb` WHERE correspondent_id = '". $str_id ."' ";
...
<head>
    ...
    <title>Correspondent edit Form</title>
...
<body>
    ...
    <div id="form" class="container-fluid">
        <div class="row">
            <div class="col-md-12" style="background-color: #fff; color:#f00; text-alige:left; font-size:36px;"> <h1>LOTTE</h1></div>
        </div>
        <div class="row">
    ...
    <form action="r_correspondent_form.php" method="post">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <input id="txt_correspondent_code" class="form-control"  type="text" name="txt_correspondent_code" value="<?=$row['correspondent_code']?>"  >
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-6">
                <input id="txt_correspondent_delivery" class="form-control" type="text" name="txt_correspondent_delivery" value="<?=$row['correspondent_code_delivery']?>" >
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-6">
                <input id="txt_correspondent_name1" class="form-control" type="text" name="txt_correspondent_name1" value="<?=$row['correspondent_name1']?>" >
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-6">
                <input id="txt_correspondent_name2" class="form-control" type="text" name="txt_correspondent_name2" value="<?=$row['correspondent_name2']?>" >
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <input id="txt_correspondent_zip" class="form-control" type="text" name="txt_correspondent_zip" value="<?=$row['correspondent_zip']?>" >
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-6">
                <input id="txt_correspondent_address1" class="form-control" type="text" name="txt_correspondent_address1" value="<?=$row['correspondent_address1_en']?>">
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-6">
                <input id="txt_correspondent_address2" class="form-control" type="text" name="txt_correspondent_address2" value="<?=$row['correspondent_address2_th']?>">
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-6">
                <input id="txt_correspondent_tel1" class="form-control" type="text" name="txt_correspondent_tel1" value="<?=$row['correspondent_tel1']?>">
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-6">
                <input id="txt_correspondent_tel2" class="form-control" type="text" name="txt_correspondent_tel2" value="<?=$row['correspondent_tel2']?>">
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-6">
                <input id="txt_correspondent_fax" class="form-control" type="text" name="txt_correspondent_fax" value="<?=$row['correspondent_fax']?>">
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-6">
                <input id="txt_correspondent_email" class="form-control" type="text" name="txt_correspondent_email" value="<?=$row['correspondent_email']?>">
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <input id="txt_correspondent_bank_code" class="form-control" type="text" name="txt_correspondent_bank_code" value="<?=$row['correspondent_bank_code']?>">
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-6">
                <input id="txt_correspondent_bank_ac_code" class="form-control" type="text" name="txt_correspondent_bank_ac_code" value="<?=$row['correspondent_bank_ac_code']?>">
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <input id="txt_correspondent_remark1" class="form-control" type="text" name="txt_correspondent_remark1" value="<?=$row['correspondent_remark1']?>">
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-6">
                <input id="txt_correspondent_remark2" class="form-control" type="text" name="txt_correspondent_remark2" value="<?=$row['correspondent_remark2']?>">
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-6">
                <input id="txt_correspondent_register_company" class="form-control" type="text" name="txt_correspondent_register_company" value="<?=$row['correspondent_register_company']?>">
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-6">
                <input id="txt_correspondent_search" class="form-control" type="text" name="txt_correspondent_search" value="<?=$row['correspondent_register_company']?>">
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-6">
                <input id="txt_correspondent_credit_limit" class="form-control" type="text" name="txt_correspondent_credit_limit" value="<?=$row['correspondent_credit_limit']?>">
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-6">
                <input id="txt_correspondent_branch_number" class="form-control" type="text" name="txt_correspondent_branch_number" value="<?=$row['correspondent_branch_no']?>">
            </div>
        </div>
        <div class="row">
            <div class="col-md-2">
