...
<body>
    <div class="contrainer-fluid">
        <div class="row">
            <div class="col-md-12">
                <h1>Correspondent type Form</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
                <h3>Corerspondent type ID</h3>
            </div>
            <div class="col-md-6">
                <input id="txtid" type="text" name="txtid" value="<?=$row['correspondent_type_id ']?>">
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
                <h3>Corerspondent type Name</h3>
            </div>
            <div class="col-md-6">
